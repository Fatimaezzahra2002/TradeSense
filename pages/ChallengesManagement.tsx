...
import ChallengeManagementTable from '../components/ChallengeManagementTable';
...
const ChallengesManagement: React.FC = () => {
  ...
  return (
    <div className="py-8 px-6 w-full max-w-full">
      <div className="mb-8">
        <h1 className="text-3xl font-bold">{t('challengesOverview')}</h1>
        <p className="text-slate-400">{t('monitorTradingChallenges')}</p>
      </div>

      <div className="modern-card overflow-hidden">
        <div className="p-6 border-b border-slate-800 flex justify-between items-center">
          <h2 className="text-xl font-bold">{t('challengesList')}</h2>
          {isSuperAdmin && (
